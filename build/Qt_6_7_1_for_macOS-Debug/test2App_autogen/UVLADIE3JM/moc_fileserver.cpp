...
struct qt_meta_stringdata_CLASSFileServerENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSFileServerENDCLASS = QtMocHelpers::stringData(
    "FileServer",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSFileServerENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject FileServer::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSFileServerENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSFileServerENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSFileServerENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *FileServer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSFileServerENDCLASS.stringdata0))
